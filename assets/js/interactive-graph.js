console.log("interacrive graph working");
...
let svgWidth = document.querySelector(".svg-container").getBoundingClientRect()
  .width;
let svgHeight = document.querySelector(".svg-container").getBoundingClientRect()
  .height;
/*-----------------------/
  TODO:
...
function resize() {
  ...
  simulation
    .force("charge", d3.forceManyBody().strength(-1000 + winWidth * 0.05))
    // center the force in the centre of the canvas
