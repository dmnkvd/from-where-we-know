(() => {
		...
		return function o(i) {
			...
			function s(t, o, s) {
				if ("undefined" != typeof document) {
					...
					var a = "";
					for (var c in s) s[c] && (a += "; " + c, !0 !== s[c] && (a += "=" + s[c].split(";")[0]));
	...
	class i {
		constructor() {
			var e;
			this.$COOKIE_MODAL = o("#cookie-modal"), this.$FEATURES = (e = ".cookie-modal__checkbox", document.querySelectorAll(e)), this.$ACCEPT_BUTTON = o("#cookie-accept"), this.$DENY_BUTTON = o("#cookie-deny"), this.$SAVE_BUTTON = o("#cookie-save"), this.MODAL_OPEN = !1, this.MINUMUM_FEATURES = ["essential"], this.MAXIMUM_FEATURES = ["#cookie-accept"], this.CUSTOM_FEATURES = [], this.SHOW_ON_FIRST = "true" === this.$COOKIE_MODAL.dataset.showOnFirst, this.initCookieModal().then((e => this.registerHooks()))
		}
		initCookieModal() {
			const e = this;
			return new Promise((t => {
				e.loadMaximumFeatures(), e.loadCustomFeatures(), 0 === e.CUSTOM_FEATURES.length && this.SHOW_ON_FIRST && e.openCookieModal(), t()
			}))
		}
		registerHooks() {
			const e = this;
			...
			})), e.$ACCEPT_BUTTON.addEventListener("click", (t => e.save(e.MAXIMUM_FEATURES))), e.$DENY_BUTTON.addEventListener("click", (t => e.save(e.MINUMUM_FEATURES))), e.$SAVE_BUTTON.addEventListener("click", (t => e.save(e.CUSTOM_FEATURES))), o("body").addEventListener("cookies:update", (t => {
			...
			event.preventDefault(),
				function (e, t = {}) {
					...
					window.CustomEvent && "function" == typeof window.CustomEvent ? o = new CustomEvent(e, {
						detail: t
					}) : (o = document.createEvent("CustomEvent"), o.initCustomEvent(e, !0, !0, t)), document.querySelector("body").dispatchEvent(o)
				}("cookies:saved", e), t.setCookie(e), t.CUSTOM_FEATURES = e, t.closeCookieModal()
		}
		updateButtons() {
			let e = this;
			e.CUSTOM_FEATURES.length > 1 ? (e.$ACCEPT_BUTTON.classList.add("hide"), e.$DENY_BUTTON.classList.add("hide"), e.$SAVE_BUTTON.classList.remove("hide")) : (e.$ACCEPT_BUTTON.classList.remove("hide"), e.$DENY_BUTTON.classList.remove("hide"), e.$SAVE_BUTTON.classList.add("hide"))
		}
		setCookie(o) {
		...
		closeCookieModal() {
			this.$COOKIE_MODAL.classList.add("cookie-modal--hidden"), this.MODAL_OPEN = !1
		}
		openCookieModal() {
			this.$COOKIE_MODAL.classList.remove("cookie-modal--hidden"), this.MODAL_OPEN = !0
		}
	}
