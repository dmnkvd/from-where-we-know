 ...
 * You can see the method in use in the `home.php`, `photography.php` and `collection.php` templates 
 * and in the `site/blueprints/sections/collections.yml` image query
